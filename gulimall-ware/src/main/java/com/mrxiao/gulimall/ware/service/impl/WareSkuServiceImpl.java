...
import com.mrxiao.gulimall.ware.dao.WareSkuDao;
...
//            //TODO 还可以用什么办法让异常出现以后不回滚？高级
            try {
                ...
                System.out.println("addStock调用productFeignService成功");
    ...
    public List<SkuHasStockVo> getSkuHasStock(List<Long> skuIds) {
        ...
        List<SkuHasStockVo> collect = skuIds.parallelStream().map(sku -> {
